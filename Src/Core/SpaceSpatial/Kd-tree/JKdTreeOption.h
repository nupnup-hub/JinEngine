...
namespace JinEngine
{
	namespace Core
	{
		...
		public:
			...
			JKdTreeOption(const J_SPACE_SPATIAL_BUILD_TYPE buildType, const J_SPACE_SPATIAL_SPLIT_TYPE splitType, const JSpaceSpatialOption& commonOption);
		public:
			bool EqualBvhOption(const JKdTreeOption& tar)const noexcept;
