#include"GraphicResourceWatcher.h"
...
namespace JinEngine
{
	GraphicResourceWatcher::GraphicResourceWatcher(std::unique_ptr<EditorAttribute> attribute, const size_t ownerPageGuid)
		:EditorWindow(std::move(attribute), ownerPageGuid)
	{}
	GraphicResourceWatcher::~GraphicResourceWatcher(){}

	void GraphicResourceWatcher::UpdateWindow(EditorUtility* editorUtility)
	{
