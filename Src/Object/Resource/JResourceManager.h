...
{  
	...
	class JResourceManagerImpl : public JDirectoryRemoveInterface, public Core::JEventManager<size_t, J_RESOURCE_EVENT_TYPE, JResourceObject*>
	{
	...
	public:
		...
		JResourceRemoveInterface* ResourceRemoveInterface() final;
		JDirectoryRemoveInterface* DirectoryRemoveInterface() final;
