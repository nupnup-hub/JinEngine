...
namespace JinEngine
{
	...
	private:
		...
		using InitPtr = JGameObject * (*)(const std::string&, const size_t, const J_OBJECT_FLAG, JGameObject*, JScene*);
		...
		using InitCallable = Core::JStaticCallable<JGameObject*, const std::string&, const size_t, const J_OBJECT_FLAG, JGameObject*, JScene*>;
	...
	public:
		...
		static JGameObject* Create(const std::string& name, const size_t guid, const J_OBJECT_FLAG flag, JGameObject& parent);
		static JGameObject* CreateRoot(const std::string& name, const size_t guid, const J_OBJECT_FLAG flag, JScene& ownerScene);
