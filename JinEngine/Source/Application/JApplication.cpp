...
namespace JinEngine
{
	namespace Application
	{
		namespace
		{
			...
			using ModuleAppAccess = Core::JModuleManagerPrivate::AppInterface;
			using PluginAppAccess = Core::JPluginManagerPrivate::AppInterface;
		}
		...
		public:
			...
			~JApplicationImpl()
			{ 
				PluginAppAccess::Clear(); 
				ModuleAppAccess::Clear(); 
