...
namespace JinEngine
{
	...
	public:
		...
		private:
			...
			void UpdateFrame(JRectLight* lit, Graphic::JRectLightConstants& constant)noexcept;
			void UpdateFrame(JRectLight* lit, Graphic::JShadowMapDrawConstants& constant)noexcept;
