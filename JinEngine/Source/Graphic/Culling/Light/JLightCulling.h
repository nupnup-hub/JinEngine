...
namespace JinEngine
{
	namespace Graphic
	{
		...
		struct JDrawHelper;
		class JLightCulling : public JGraphicTaskInterface, public JGraphicDeviceShaderHandler
		{
		public: 
		...
		public:
			virtual void NotifyNewClusterOption(JGraphicDevice* device, const JGraphicBaseDataSet& baseDataSet) = 0;
		...
		public: 
			virtual void StreamOutDebugInfo(const std::wstring& path, const JGraphicBaseDataSet& baseDataSet) = 0;
		};
	}
}