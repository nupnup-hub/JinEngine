...
{ 
	...
	namespace Editor
	{
		...
		{
		public:
			using RenameF = Core::JFunctor<void, const std::string, Core::JUserPtr<Core::JIdentifier>>;
		private:
			Core::JUserPtr<Core::JIdentifier> renameTar;
		...
		public:
			void Activate(Core::JUserPtr<Core::JIdentifier> newRenameTar)noexcept;
		public:
