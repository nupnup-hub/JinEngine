...
// - Newcomers, rea 'Programmer guide' in imgui.cpp for notes on how to setup Dear ImGui in your codebase.
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Range Widgets"))
    {
        ...
        ImGui::DragFloatRange2("length float", &begin, &end, 0.25f, 0.0f, 100.0f, "Min: %.1f %%", "Max: %.1f %%", ImGuiSliderFlags_AlwaysClamp);
        ImGui::DragIntRange2("length int", &begin_i, &end_i, 5, 0, 1000, "Min: %d units", "Max: %d units");
        ImGui::DragIntRange2("length int (no bounds)", &begin_i, &end_i, 5, 0, 0, "Min: %d units", "Max: %d units");
        ImGui::TreePop();
    }
    ...
    if (ImGui::TreeNode("Data Types"))
    {
        ...
        // Note: SliderScalar() functions have a maximum usable length of half the natural type maximum, hence the /2.
        #ifndef LLONG_MIN
...
static void ShowPlaceholderObject(const char* prefix, int uid)
{
    ...
    ImGui::TableSetColumnIndex(0);
    ImGui::AlignTextToFramePadding();
    bool node_open = ImGui::TreeNode("JObject", "%s_%u", prefix, uid);
    ImGui::TableSetColumnIndex(1);
...
static void ShowExampleAppPropertyEditor(bool* p_open)
{
    ...
    if (ImGui::BeginTable("split", 2, ImGuiTableFlags_BordersOuter | ImGuiTableFlags_Resizable))
    {
        ...
        {
            ShowPlaceholderObject("JObject", obj_i);
            //ImGui::Separator();
        }
        ImGui::EndTable();
    }
